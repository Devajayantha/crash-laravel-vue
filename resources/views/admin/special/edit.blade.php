...
<head>
    ...
    <div id="app">
        ...
        <div class="container">
            <form action="/admin/special/{{ $special -> id }}" method="POST">
                @method('patch')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input value="{{ $special -> was_price }}" type="number" step="0.01" class="form-control" name="was_price" placeholder="Enter Was Price">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1" >Current Price</label>
                    <input value="{{ $special -> current_price }}" type="number" step="0.01" class="form-control" name="current_price" placeholder="Enter Current Price">
                </div>
